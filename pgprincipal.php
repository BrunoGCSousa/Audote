...
<html lang="pt-br" class="audote-root">
    ...
    <body>
                ...
                <div class="header-container">
                    <div class="logo-nav-container">
                        ...
                        <div class="nav-trigger navbar light">
                            ...
                            <div
                                class="offcanvas offcanvas-start nav-mobile-container"
                                tabindex="-1"
                                id="mobileNav"
                            >
                    ...
                    <div class="search-container d-none d-xl-block">
                        <div class="hero-form hero-form-round smaller">
                            <form
                    ...
                    <nav class="user-nav d-none d-sm-flex">
                        <a
                            href="#"
                            class="btn rounded-pill nav-btn"
                            >Entrar</a
                        >
                    </nav>
                </div>
        ...
        <section
            class="hero hero-bg cover"
            style="background-image: url(src/img/hero-bg-2.jpg)"
        >
            ...
            <div class="mx-5">
                ...
                <div class="pets">
                    <div class="lista-de-imagens row">
                        <div
                            class="pet col-4"
                            style="--imagem-fundo: url('../img/1.jpg')"
                        >
                            <div class="preto"></div>
                            <div class="descricao">
                                <h2>Serginho</h2>
                                ...
                                <div class="oculto">
                                    ...
                                    <p>
                                        Esse cachorro é muito lindo e pipipopo
                                        foi adotado não sei onde não sei por
                                        quem e pipipopo
                                    </p>
                                    <ul>
                                        <li>Vermifugado</li>
                        ...
                        <div
                            class="pet col-4"
                            style="--imagem-fundo: url('../img/2.jpg')"
                        >
                            <div class="preto"></div>
                            <div class="descricao">
                                <h2>Serginho</h2>
            ...
            <div class="row justify-content-md-center">
                <div class="card col-xl-3 col-lg-5 col-sm-12 col-md-12 mx-3">
                    ...
                    <div class="textBox">
                        ...
                        <p class="text price">Ao adotar um animal, você está oferecendo uma segunda chance a um ser vivo que precisa de um lar. Em vez de contribuir para o comércio de animais, você está ajudando a reduzir o número de animais abandonados e a combater o problema do superpovoamento em abrigos</p>
                    </div>
                </div>
                <div class="card col-xl-3 col-lg-5 col-sm-12 col-md-12 mx-3">
                    ...
                    <div class="textBox">
                        ...
                        <p class="text price">Animais de abrigo muitas vezes passaram por situações difíceis e estão sedentos por amor e cuidado. Ao adotar, você está dando a eles a oportunidade de experimentar o afeto e a segurança de um lar amoroso. Em troca, eles retribuem com amor incondicional e lealdade</p>
                    </div>
                </div>
                <div class="card col-xl-3 col-lg-10 col-sm-12 col-md-12 mx-3">
                    ...
                    <div class="textBox">
                        ...
                        <p class="text price">Abrigos e organizações de resgate abrigam uma ampla variedade de animais, de diferentes raças, idades e tamanhos. Você pode encontrar o companheiro perfeito para sua família, independentemente das suas preferências. Há um amigo peludo esperando por você em um abrigo</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="mb-100 mt-100">
            <div class="container">
                <div
                    class="promo-img cover pt-100 pb-100"
                    style="background-image: url(src/img/bg1.jpg)"
                >
                    <div class="row">
        ...
        <!-- Footer -->
        <footer
            class="site-footer style-1 mt-100"
            id="footer"
            style="background-image: url(src/img/bg10.png)"
        >
