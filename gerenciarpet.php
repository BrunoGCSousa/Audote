...
<body>
    ...
    <?php include('./secoes/nav.php') ?>
        ...
        <div class="mt-100 table-responsive">
        <h1 class="text-center h1">Gerencie os seus Pets <i class="fa-solid fa-dog"></i></h1>
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col">Id</th>
        ...
        <form action="editarPet.php" method="POST" class="container cadastrar-pet">
            ...
            <div class="row">
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <input required type="number" value="<?php echo @$_GET['idadePet']; ?>" name="idadePet"
            ...
            <div class="row">
                <div class="mb-3 col-md-6">
                    ...
                    <select class="form-select" id="vacinas" name="vacinas" required>
                        <option selected value="<?php echo @$_GET['vacinas']; ?>"><?php echo @$_GET['vacinas']; ?>
                        </option>
            ...
            <div class="mb-3">
                ...
                <textarea name="caracteristicas" id="caracteristicas" cols="30" rows="10" required class="form-control"
                    maxlength="255"><?php echo @$_GET['caracteristicas']; ?></textarea>
            </div>
